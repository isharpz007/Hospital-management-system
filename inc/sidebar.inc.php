    ...
    <div class='sidebar'>
        <div class='sidebar-area'> 
            ...
            <ul class='sidebar-menu'>
                ...
                <li><a href='profile.php?token=<?php echo htmlspecialchars($userDetails['token']); ?>'><img class='sidebar-menu-icon' src='images/ic_account_box_white_24dp.png'  /> Profile</a></li>
    ...
    <div class='sidebar'>
        <div class='sidebar-area'> 
            <div class='row' style='margin-bottom: 20px;'> 
                ...
                <div class='col-md-6'> 
                    <div class='user-names'> 
                        <?php echo htmlspecialchars(Patient::getP($_SESSION['patient'], "name")); ?>
                    </div>
